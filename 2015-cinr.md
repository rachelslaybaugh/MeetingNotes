...
thoughts:
  - Find out if MOOSE/RattleSake must go with TREAT (Rachel)
  - If so, reach out to PROTEUS team; learn about current PROTEUS capabilities (Rachel and Richard)
  ...
  - Ask Max and Per and Jasmina about potential overlaps / collaboration (Rachel)
  - Look into NSUF computing resources (Richard and Rachel)
  - Get webinar slides (Rachel)
