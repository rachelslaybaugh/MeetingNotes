...
1. If U.S. does not adopt type of initiative in the report, there will be no nuclear in 20 years
2. brining any concept of nuclear power from here to FOAK will take 15 years and cost $10B 
3. any time someone mentions a new nuclear concept, ask for a rough outline of schedule and cost to get from here to FOAK
...
- program structure: 4 phase program for an advanced reactor system
  1. R&D, downselect
  2. component development, RNC licensing
  3. demonstration plant construction and operation (if needed)
  4. construction of FOAK commercial plant
...
**Jessica Lovering and How to Make Nuclear Cheap**
- inherent safety
...
**Charles Forsberg, Designing Advanced NPPs**
...
**Jake Jurewicz, Leveraging New Technologies to Reduce Costs**
...
**Bob Schleicher (GA), Can GFRs Meet the Challenge?**
...
**Paolo Ferroni (W), Lead-cooled Fast Reactors**
